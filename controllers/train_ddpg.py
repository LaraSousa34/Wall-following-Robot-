...
#defining the DDPG as the DRL model for training
#n_actions = env.action_space.shape[-1]
#action_noise = NormalActionNoise(mean=np.zeros(n_actions), sigma=0.1 * np.ones(n_actions))
#model = DDPG('MlpPolicy', env, action_noise=action_noise, verbose=1, tensorboard_log=tensorboard_log_dir)

# loading the saved model
#model=DDPG.load(r'/Users/larasousa/Desktop/IRI/controllers/Training/DDPG/20000', env)
#model=DDPG.load(r'/Users/larasousa/Desktop/IRI/controllers/Training/DDPG_2/20000', env)
#model=DDPG.load(r'/Users/larasousa/Desktop/IRI/controllers/Training/DDPG_3/20000', env)
#model=DDPG.load(r'/Users/larasousa/Desktop/IRI/controllers/Training/DDPG_4_5/40000', env)
model=DDPG.load(r'/Users/larasousa/Desktop/IRI/controllers/Training/DDPG_4_5_2/40000', env)


#saving the model: creating a zip file
#model.save("ddgp_wallfollowing")
...
while iters < max_iters:
    ...
    #_____________________________________________________________________________let's save our model!
    # create Trainig/DDPG's folders in the same directory where we have the python files
    # inside that the files are saved
    #model.save(f"{'Training/DDPG'}/{timesteps * iters}")
    #model.save(f"{'Training/DDPG_2'}/{timesteps * iters}")
    #model.save(f"{'Training/DDPG_3'}/{timesteps * iters}")
    #model.save(f"{'Training/DDPG_4_5'}/{timesteps * iters}")
    #model.save(f"{'Training/DDPG_4_5_2'}/{timesteps * iters}")
    model.save(f"{'Training/DDPG_4_5_3'}/{timesteps * iters}")
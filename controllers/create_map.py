...
if __name__ == '__main__':
    custom_maps_filepath: str = 'C:\\Users\\beatr\\Desktop\\UNI\\3ºANO\\2semestre\\Robotica\\Trabalho\\Atual\\IRI\\worlds\\pngs\\'
    map_name: str = 'O'

    yaml_data = {
        'image': 'O.png',  # Nome da imagem
        'resolution': 0.005,  # Resolução do mapa
        'origin': [0.0, 0.0, 0.0],  # Origem do mapa
        'occupied_thresh': 0.65  # Limite para considerar um pixel como parede
    }
